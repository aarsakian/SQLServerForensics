...
type Boot struct {
	...
	Dbi_dbname              [256]byte
	Dbi_Dbid                uint16
	Dbi_cmptlevel           uint16
	Dbi_masterfixups        uint16
	Dbi_maxDbTimestamp      uint16
	Dbi_dbbackupLSN2        utils.LSN //?
	Dbi_RebuildLogs         uint16
	Dbi_differentialBaseLSN utils.LSN
	Dbi_RestoreFlags        [2]byte
	Dbi_checkptLSN          utils.LSN
	...
	/*Dbi_lastxact	0x171a
	  ...
	  Dbi_relstat	0x75813000
	  Dbi_PartitionDbFlags	0
	  Dbi_familyGUID	3e94febd-98ca-424f-8787-5dd24a6e3976
