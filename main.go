...
func main() {
	...
	showPageStats := flag.Bool("showpagestats", false, "show page statistics sgam, gam, pfs iam for selected pages")
	...
	exportImage := flag.Bool("exportimages", false, "export blobs (will be exported to a folder images under the database name)")
